 CREATE TABLE CDR_INPUT_IMS_NOKIA_ROI
 (
   ...
   VISITED_NETWORK_ID VARCHAR2(512)   
 )
 ...
 -- Create Indexes
 --
 CREATE INDEX CDR_INPUT_IMS_ROI_IDX1 ON CDR_INPUT_IMS_NOKIA_ROI (A_NUMBER) LOCAL;
 
 CREATE INDEX CDR_INPUT_IMS_ROI_IDX2 ON CDR_INPUT_IMS_NOKIA_ROI (B_NUMBER) LOCAL;
 
 CREATE INDEX CDR_INPUT_IMS_ROI_IDX3 ON CDR_INPUT_IMS_NOKIA_ROI (IMS_CHARGING_ID) LOCAL;
 
 CREATE INDEX CDR_INPUT_IMS_ROI_IDX4 ON CDR_INPUT_IMS_NOKIA_ROI (CREATED_DATE) LOCAL;

 CREATE INDEX CDR_INPUT_IMS_ROI_IDX5 ON CDR_INPUT_IMS_NOKIA_ROI (TRANSACTION_ID) LOCAL;
