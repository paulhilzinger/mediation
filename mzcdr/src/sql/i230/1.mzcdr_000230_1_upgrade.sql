-- MED-613. Improve performance of AOCS BU Build Function
...
--Add new index
CREATE INDEX MZ_CDR_OWNER.AOCS_ISR_RESOURCES_IDX2 ON MZ_CDR_OWNER.AOCS_ISR_RESOURCES ("RESOURCE_VALUE_STR");