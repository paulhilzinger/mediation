...
CREATE OR REPLACE VIEW "MZ_MOB_DATA_OWNER"."MONSOL_SMSC_ROAMING_4" ("MEDIATION_INSERTION_TIME", "EVENT_TIME", "SM_ID", "ORG_ACCOUNT", "DEST_ACCOUNT", "MTMSCADDR", "LOCUSSMSTATUS") AS 
