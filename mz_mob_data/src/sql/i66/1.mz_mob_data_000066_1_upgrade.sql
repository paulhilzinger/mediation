...
CREATE TABLE MZ_MOB_DATA_OWNER.CDR_INPUT_SMSC_SINCH
(
...
CREATE INDEX CDR_INPUT_SMSC_SINCH_IDX1 ON CDR_INPUT_SMSC_SINCH (ORIG) LOCAL;

CREATE INDEX CDR_INPUT_SMSC_SINCH_IDX2 ON CDR_INPUT_SMSC_SINCH (DEST1) LOCAL;

CREATE INDEX CDR_INPUT_SMSC_SINCH_IDX3 ON CDR_INPUT_SMSC_SINCH (CREATED_DATE) LOCAL;

CREATE INDEX CDR_INPUT_SMSC_SINCH_IDX4 ON CDR_INPUT_SMSC_SINCH (TRANSACTION_ID) LOCAL;
