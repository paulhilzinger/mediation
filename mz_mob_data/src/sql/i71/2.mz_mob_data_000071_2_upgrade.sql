CREATE TABLE MZ_MOB_DATA_OWNER.CDR_INPUT_IMS_NOKIA
( 
...
INITIAL_ICID                  VARCHAR2(128 BYTE),
...
CREATE INDEX CDR_INPUT_IMS_NOKIA_IDX1 ON CDR_INPUT_IMS_NOKIA (CALLING_PARTY) LOCAL;          
                                                                                      
CREATE INDEX CDR_INPUT_IMS_NOKIA_IDX2 ON CDR_INPUT_IMS_NOKIA (CALLED_PARTY) LOCAL;         
                                                                                      
CREATE INDEX CDR_INPUT_IMS_NOKIA_IDX3 ON CDR_INPUT_IMS_NOKIA (CREATED_DATE) LOCAL;  
                                                                                      
CREATE INDEX CDR_INPUT_IMS_NOKIA_IDX4 ON CDR_INPUT_IMS_NOKIA (TRANSACTION_ID) LOCAL;