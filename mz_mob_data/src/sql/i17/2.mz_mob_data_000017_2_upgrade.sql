...
-- MZMOB-202 Deployment for IGOR 2017-03-09 [BK]
...
-- *       2. DROP_SECONDARY_INDEX()
-- *       3. TRUNCATE_TABLE()
-- *       4. Load new data into the Mediation Zone copy of the OCS tables
-- *       5. ADD_SECONDARY_INDEX()
-- *       6. REBUILD_INDEX()
-- *       7. ENABLE_FOREIGN_KEYS()
-- *
-- *    WARNING:
